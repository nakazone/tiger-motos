  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <div className="max-w-7xl mx-auto w-full pl-4 sm:pl-6 lg:pl-8 pr-4 sm:pr-6 lg:pr-8 py-16">
        {/* Header */}
        <div className="mb-12">
          <h1 className="text-5xl font-bold text-white mb-4 text-left">SOBRE A TIGER MOTOS</h1>
        </div>
        ...
        <div className="bg-gray-900 shadow-lg p-8 border border-gray-800">
          <div className="prose prose-lg max-w-none">
            ...
            <h3 className="text-xl font-semibold text-white mb-4 text-left">Nossa Missão</h3>
            <p className="text-gray-300 mb-6 text-left">
            ...
            <h3 className="text-xl font-semibold text-white mb-4 text-left">O que Oferecemos</h3>
            <ul className="list-disc list-inside text-gray-300 mb-6 space-y-2 text-left">
            ...
            <h3 className="text-xl font-semibold text-white mb-4 text-left">Nosso Compromisso</h3>
            <p className="text-gray-300 mb-6 text-left">
            ...
            <div className="bg-gray-800 p-6 mt-8 border border-gray-700">
              <h3 className="text-xl font-semibold text-white mb-3 text-left">Visite-nos</h3>
