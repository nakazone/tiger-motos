        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a 
                href="https://www.facebook.com/profile.php?id=100015787785904&ref=_ig_profile_ac"
                target="_blank"
              ...
              <a 
                href="https://www.instagram.com/tigermotos_/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
              >
          ...
          <div className="text-left">
            ...
            <div className="space-y-2 text-gray-300">
              <div className="flex items-start">
                ...
                <span>Av. Irmãos Adorno, 186<br />Sítio do Campo, Praia Grande</span>
              </div>
              <div className="flex items-center">
                <svg className="h-5 w-5 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                </svg>
                <span>(13) 99103-0606</span>
              </div>
              <div className="flex items-center">
                <svg className="h-5 w-5 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span>contato@tigermotos.com.br</span>
              </div>
              <div className="flex items-center">
                <img 
                  src="/whatsapp.png" 
